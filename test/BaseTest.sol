...
import {INonfungiblePositionManager} from "@erc20z/interfaces/uniswap/INonfungiblePositionManager.sol";
import {ISwapRouter} from "@erc20z/interfaces/uniswap/ISwapRouter.sol";
import {IERC20Z} from "@erc20z/interfaces/IERC20Z.sol";
import {ERC20Z} from "@erc20z/ERC20Z.sol";
import {IZoraTimedSaleStrategy} from "@erc20z/interfaces/IZoraTimedSaleStrategy.sol";
import {IReduceSupply} from "@zoralabs/shared-contracts/interfaces/IReduceSupply.sol";
import {ProtocolRewards} from "@erc20z-test/mock/ProtocolRewards.sol";
import {ICreatorRoyaltiesControl} from "@erc20z-test/mock/ICreatorRoyaltiesControl.sol";
import {Zora1155} from "@erc20z-test/mock/Zora1155.sol";
import {Zora1155 as Zora1155NoReduceSupply} from "@erc20z-test/mock/Zora1155NoReduceSupply.sol";
...
contract BaseTest is Test {
    ...
    uint256 internal constant mintFee = 0.0004 ether;
    ...
    uint256 internal constant DEFAULT_MINIMUM_MARKET_ETH = 0.1 ether;
